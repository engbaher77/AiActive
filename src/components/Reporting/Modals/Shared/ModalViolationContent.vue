      ...
      <tbody id="printable">
        ...
        <tr style="height: 35px;">
          <td style="height: 35px;" colspan="4" width="720">
            <figure
              class="figure"
              style="width:141px;height:114px;padding:5px;"
            >
              <img class="img-fluid figure-img" src="" />
            </figure>
          </td>
        </tr>
        ...
        <tr style="height: 35px;">
          <td style="height: 35px;" width="264">
            <p style="text-align: center;">
              ﻛم<em>/</em>ﺳﺎعه {{ violationToPrint.speed / 100 }}
            </p>
          </td>
        ...
        <tr style="height: 35px;">
          ...
          <td style="height: 105px;" colspan="2" rowspan="3" width="349">
            ...
            <p style="text-align: right;">
              جهاز رقم &nbsp;&nbsp; {{ violation.device_name }}
            </p>
            <p>&nbsp;</p>
          </td>
        </tr>
...
<script>
export default {
  props: ["doPrint", "violationToPrint","printPreview"],
